...
const Dashboard = () => {
  ...
  useEffect(() => {
    if (isAuthenticated) {
      fetchWallet();
      fetchTransactions(5); // fetch 5 most recent for dashboard overview
    }
  }, [isAuthenticated]);
...
=======
  ...
  // Compute totals from real transaction data
                ...
                {walletLoading && transactions.length === 0 ? (
                  ...
                  <div className="overflow-hidden">
                    <table className="w-full">
                      ...
                      <tbody>
                        {parsedTransactions.map((txn: ReturnType<typeof parseTransaction>) => (
